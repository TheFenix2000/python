...
#
#
# Some unit function to be run against a sample Nessus XML file
#   ./function/rewriting_contest_of_a_file.xml
...
class test_NessusXMLParser(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(self):
        example_file = os.path.join(tests_folder,'rewriting_contest_of_a_file.xml')
